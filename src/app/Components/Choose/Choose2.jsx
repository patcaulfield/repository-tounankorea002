              ...
              <div className="col-lg-6">
                <div className="heading2">
                  ...
                  <div className="item-box" data-aos="fade-right" data-aos-duration="900">
                    <div className="icon">
                      <div className="">
                      <Image src="/assets/img/icons/solution-iocn1.png" alt="img" width={28} height={28}   />
                      </div>
                    </div>
                    <div className="">
                  ...
                  <div className="item-box" data-aos="fade-right" data-aos-duration="1100">
                    <div className="icon">
                      <div className="">
                      <Image src="/assets/img/icons/solution-iocn2.png" alt="img" width={28} height={28}   />
                      </div>
                    </div>
                    <div className="">
                  ...
                  <div className="" data-aos="fade-right" data-aos-duration="800">
                    <Link className="theme-btn2" href="/service">Discover More <span className="arrow1"><i className="bi bi-arrow-right"></i></span><span className="arrow2"><i className="bi bi-arrow-right"></i></span></Link>
                  </div>
                </div>
              </div>
