          ...
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-lg-4">
                <div className="" data-aos="fade-right" data-aos-duration="700">
                  <div className="service3-box">
                    <div className="">
                      <div className="icon">
                      <Image src="/assets/img/icons/service3-iocn1.png" alt="img" width={24} height={24}   />
                      </div>
                    </div>
                    <div className="heading3">
                ...
                <div className="" data-aos="fade-right" data-aos-duration="1100">
                  <div className="service3-box">
                    <div className="">
                      <div className="icon">
                      <Image src="/assets/img/icons/service3-iocn2.png" alt="img" width={24} height={24}   />
                      </div>
                    </div>
                    <div className="heading3">
                      <h4><Link href="/service/service-details">Cloud Solution</Link></h4>
                      <div className="space16"></div>
                ...
                <div className="" data-aos="fade-right" data-aos-duration="900">
                  <div className="service3-box">
                    <div className="">
                      <div className="icon">
                      <Image src="/assets/img/icons/service3-iocn3.png" alt="img" width={24} height={24}   />
                      </div>
                    </div>
                    <div className="heading3">
                      <h4><Link href="/service/service-details">Data Analytics</Link></h4>
                      <div className="space16"></div>
              ...
              <div className="col-lg-4">
                ...
                <Image src="/assets/img/service/service3-img.png" alt="img" width={416} height={577}   />
                </div>
              </div>
              ...
              <div className="col-lg-4">
                <div className="" data-aos="fade-left" data-aos-duration="700">
                  <div className="service3-box">
                    <div className="">
                      <div className="icon">
                      <Image src="/assets/img/icons/service3-iocn4.png" alt="img" width={24} height={24}   />
                      </div>
                    </div>
                    <div className="heading3">
                ...
                <div className="" data-aos="fade-left" data-aos-duration="1100">
                  <div className="service3-box">
                    <div className="">
                      <div className="icon">
                      <Image src="/assets/img/icons/service3-iocn5.png" alt="img" width={24} height={24}   />
                      </div>
                    </div>
                    <div className="heading3">
                      <h4><Link href="/service/service-details">Cyber Security</Link></h4>
                      <div className="space16"></div>
                ...
                <div className="" data-aos="fade-left" data-aos-duration="900">
                  <div className="service3-box">
                    <div className="">
                      <div className="icon">
                      <Image src="/assets/img/icons/service3-iocn6.png" alt="img" width={24} height={24}   />
                      </div>
                    </div>
                    <div className="heading3">
                      <h4><Link href="/service/service-details">Manage It Service</Link></h4>
                      <div className="space16"></div>
