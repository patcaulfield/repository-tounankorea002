    ...
    return (
        ...
        <div className="container">
            ...
            <div key={i} className="col-lg-4 col-md-6">
              <div className="">
                <div className="servcie2-box">
                  <div className="icon">
                  <Image src="/assets/img/icons/service2-icon3.png" alt="img" width={24} height={24}   />
                  </div>
          ...
          <div className="row">
            ...
            <Link className="theme-btn2" href="/service">View All Services <span><i className="bi bi-arrow-right"></i></span></Link>
            </div>
          </div>
