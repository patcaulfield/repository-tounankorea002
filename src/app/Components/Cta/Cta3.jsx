        ...
        <div className="cta4">
            <div className="container">
                <div className="cta-bg-area">
                    ...
                    <Image className="shape1 shape-animaiton3" src="/assets/img/shapes/cta4-shape1.png" alt="img" width={132} height={129}   />
                    <Image className="shape2 shape-animaiton3" src="/assets/img/shapes/cta4-shape2.png" alt="img" width={227} height={224}   />
