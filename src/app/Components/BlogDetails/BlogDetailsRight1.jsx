                        ...
                        <div className="service-details-post">
                            <article>
                                <div className="details-post-area">
                                    <div className="image">
                                    <Image src="/assets/img/others/project-details-img1.png" alt="img" width={838} height={503}   />
                                    </div>
                                    <div className="social-users">
                                        <ul>
                                        <li><a href="#"><Image src="/assets/img/icons/user-icon1.png" alt="img" width={16} height={16}   /> John William</a></li>
                                            <li><a href="#"><Image src="/assets/img/icons/user-icon2.png" alt="img" width={16} height={16}   /> Feb 25, 24</a></li>
                                            <li><a href="#"><Image src="/assets/img/icons/user-icon3.png" alt="img" width={16} height={16}   /> Cyber Security</a></li>
                                            <li><a href="#"><Image src="/assets/img/icons/user-icon4.png" alt="img" width={20} height={16}   /> 03 Comments</a></li>
                                        </ul>
                                    </div>
                            ...
                            <article>
                                <div className="details-post-area">
                                    <div className="video-area-image">
                                        <div className="image">
                                        <Image src="/assets/img/blog/blog-post-video-img.png" alt="img" width={838} height={503}   />
                                        </div>
                                    </div>
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="sidebar-box-area sidebar-bg mb-40">
                          ...
                          <ul className="features-list">
                                <li><Link href="/service/service-details">Software Development <span><i className="bi bi-chevron-right"></i></span></Link></li>
                                <li><Link href="/service/service-details">Consulting Service <span><i className="bi bi-chevron-right"></i></span></Link></li>
                                <li><Link href="/service/service-details">Cloud Solution <span><i className="bi bi-chevron-right"></i></span></Link></li>
                                <li><Link href="/service/service-details">Cyber Security <span><i className="bi bi-chevron-right"></i></span></Link></li>
                                <li><Link href="/service/service-details">Data Analytics <span><i className="bi bi-chevron-right"></i></span></Link></li>
                                <li><Link href="/service/service-details">Manage It Services <span><i className="bi bi-chevron-right"></i></span></Link></li>
                          </ul>
                      </div>
                      ...
                      <div className="sidebar-box-area sidebar-bg mb-40">
                          ...
                          <div className="sidebar-blog-boxs">
                              <div className="sidebar-blogs">
                                  <div className="">
                                      <div className="image">
                                      <Image src="/assets/img/blog/blog-details-sidebar1.png" alt="img" width={100} height={100}   />
                                      </div>
                                  </div>
                                  <div className="heading">
                                      <a href="#" className="date"><Image src="/assets/img/icons/date.png" alt="img" width={20} height={20}   /> 19/02/2024</a>
                                      <h5><Link href="/blog/blog-details">We take a deep dive into the future of cloud computing </Link></h5>
                                  </div>
                              </div>
                              ...
                              <div className="sidebar-blogs">
                                  <div className="">
                                      <div className="image">
                                      <Image src="/assets/img/blog/blog-details-sidebar2.png" alt="img" width={100} height={100}   />
                                      </div>
                                  </div>
                                  <div className="heading">
                                      <a href="#" className="date"><Image src="/assets/img/icons/date.png" alt="img" width={20} height={20}   /> 19/02/2024</a>
                                      <h5><Link href="/blog/blog-details">Our team of experts will provide in-depth analysis </Link></h5>
                                  </div>
                              </div>
                              ...
                              <div className="sidebar-blogs">
                                  <div className="">
                                      <div className="image">
                                      <Image src="/assets/img/blog/blog-details-sidebar3.png" alt="img" width={100} height={100}   />
                                      </div>
                                  </div>
                                  <div className="heading">
                                      <a href="#" className="date"><Image src="/assets/img/icons/date.png" alt="img" width={20} height={20}   /> 19/02/2024</a>
                                      <h5><Link href="/blog/blog-details">Our case studies and success stories highlight real-world </Link></h5>
                                  </div>
                              </div>
                              ...
                              <div className="sidebar-blogs">
                                  ...
                                  <div className="heading">
                                      <a href="#" className="date"><Image src="/assets/img/icons/date.png" alt="img" width={20} height={20}   /> 19/02/2024</a>
                                      <h5><Link href="/blog/blog-details">One of the primary objectives of cybersecurity is to protect </Link></h5>
                                  </div>
                              </div>
                      ...
                      <div className="sidebar-box-area sidebar-bg mb-40">
                          ...
                          <a className="daownload1" href="#">PDF Download <Image src="/assets/img/icons/download-img.png" alt="img" width={19} height={18}   /></a>
                          <a className="daownload2" href="#">DOC Download <Image src="/assets/img/icons/download-img.png" alt="img" width={19} height={18}   /></a>
                          </div>
                      </div>
