        ...
        <div className="container">
          <div className="cs_main_header_in">
            ...
            <div className="cs_main_header_left">
              ...
              <Image src="/assets/img/logo/header4-logo.png" alt="img" width={130} height={28}   />
              </Link>
              </div>
            ...
            <Link className="theme-btn5" href="/contact">Get A Quote <span><i className="bi bi-arrow-right"></i></span></Link>
					  </div>
            </div>
          </div>
        </div>
