                        ...
                        <div className="service-details-post">
                            <article>
                                <div className="details-post-area">
                                    <div className="image">
                                    <Image src="/assets/img/service/service-details-img.png" alt="img" width={838} height={503}   />
                            ...
                            <div className="row">
                              <div className="col-lg-6 col-md-6">
                                <div className="">
                                  <div className="servcie2-box servcie2-box-2">
                                    <div className="icon">
                                    <Image src="/assets/img/icons/service-page-icon1.png" alt="img" width={24} height={24}   />
                                    </div>
                                    <Link href="/service/service-details" className="arrow"><i className="bi bi-arrow-right"></i></Link>
                                    <div className="heading1">
                                      <h4><Link href="/service/service-details">Consulting Service</Link></h4>
                                      <div className="space16"></div>
                              ...
                              <div className="col-lg-6 col-md-6">
                                <div className="">
                                  <div className="servcie2-box servcie2-box-2">
                                    <div className="icon">
                                    <Image src="/assets/img/icons/service-page-icon2.png" alt="img" width={24} height={24}   />
                                    </div>
                                    <Link href="/service/service-details" className="arrow"><i className="bi bi-arrow-right"></i></Link>
                                    <div className="heading1">
                                      <h4><Link href="/service/service-details">Software Development</Link></h4>
                                      <div className="space16"></div>
