              ...
              <div className="images">
                <div className="row">
                  <div className="col-lg-12">
                    <div className="image">
                    <Image src="/assets/img/about/visiton-img1.png" alt="img" width={636} height={357}   />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6">
                    ...
                    <div className="image">
                    <Image src="/assets/img/about/visiton-img2.png" alt="img" width={306} height={283}   />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6">
                    <div className="space30"></div>
                    <div className="image">
                    <Image src="/assets/img/about/visiton-img3.png" alt="img" width={306} height={283}   />
                    </div>
                  </div>
