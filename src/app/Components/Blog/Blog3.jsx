          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="blog3-box" data-aos="zoom-in-up" data-aos-duration="1100">
                ...
                <h3><Link href="/blog/blog-details">Discover How Organisations Like Yours Have Leveraged Technology</Link></h3>
                <div className="space16"></div>
                <p>Our case studies and success stories highlight real-world examples of how TechXen has helped clients overcome challenges and achieve.</p>
                <div className="space16"></div>
                <Link href="/blog/blog-details" className="learn">Read More <span><i className="bi bi-arrow-right"></i></span></Link>
                </div>
                <div className="image image-anime">
